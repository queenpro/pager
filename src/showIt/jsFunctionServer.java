...
//////        // </editor-fold>
        ...
        dbCode += "function parseCommandItem(JSONitem) {\n"
                ...
                + "var msg;\n"
                + "var htmlCode;\n"
                //                + "console.log(\"parseCommandItem ricevuto-->\"+JSONitem );"
...
// </editor-fold>
        ...
        dbCode += "function rightClicked(FORMID,INSTANCEID,OBJNAME,OBJKEY,ACTION,LEVEL,obj,event){\n"
                ...
                + "<INPUT type='TEXT' "
                + "id = '\"+idList+\"' "
                //                + "onclick='javascript:CRUDnestedList("
                //                + "\"+apostrofo+FORMID+apostrofo+\","
                //                + "\"+apostrofo+INSTANCEID+apostrofo+\","
                //                + "\"+apostrofo+OBJNAME+apostrofo+\","
                //                + "\"+apostrofo+OBJKEY+apostrofo+\","
                //                + "\"+apostrofo+modifyValue+apostrofo+\","
                //                + "\"+apostrofo+LEVEL+apostrofo+\" " 
                //                + ")'  "
                + "><a>SALVA</a>"
                + "</td></tr>\";"
                + " ctxmCode+=\"</table>\";\n"
...
//=================================================
    ...
    public String getManageUpDownload() {
        ...
        String dbCode = "function uploadPicture(P1, P2, P3)\n"
                ...
                + "function groupChecker(jarguments)\n"
                + "{\n"
                + "    var paramj = JSON.stringify(jarguments);\n"
                + "    var myArg = JSON.parse(paramj);\n"
                + "     var formID= myArg.formID;\n"
